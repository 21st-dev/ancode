/**
 * CLI command support for crunch
 * Allows users to open crunch from terminal with: crunch . or crunch /path/to/project
 *
 * Based on PR #16 by @caffeinum (Aleksey Bykhun)
 * https://github.com/getcrunch-dev/crunch/pull/16
 */
...
// Launch directory from CLI (e.g., `crunch /path/to/project`)
 ...
 * Called on app startup to handle `crunch .` or `crunch /path/to/project`
 */
