...
// PostgreSQL logo icon (for future use)
export function PostgresIcon(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M23.5594 14.7228a.5269.5269 0 0 0-.0563-.1191c-.139-.2632-.4768-.3418-1.0074-.2321-1.6533.3411-2.2935.1312-2.5256-.0191 1.342-2.0482 2.445-4.522 3.0411-6.8297.2714-1.0507.7982-3.5237.1222-4.7316a1.5641 1.5641 0 0 0-.1509-.235C21.6931.9086 19.8007.0248 17.5099.0005c-1.4947-.0158-2.7705.3461-3.1161.4648a9.5862 9.5862 0 0 0-.5765-.0227c-1.7067-.0545-3.0822.448-4.1254 1.4896-.9356-.3253-4.1274-1.3283-6.0525-.6969a2.2468 2.2468 0 0 0-.8454.5559c-1.928 2.1255-.3806 6.9255.5132 9.0477-.0623.3627-.0899.7287-.0899 1.0925 0 .5168.0707 1.1013.2326 1.6488-.8293.5765-1.4566 1.4035-1.6136 2.5307-.3084 2.2092.8965 3.1911 2.1117 3.5512.7197.2132 1.5223.2604 2.2932.1393a5.1917 5.1917 0 0 0 .0933.4184c.2556.932.7778 1.7469 1.4696 2.2949.7594.6016 1.6377.8916 2.5759.8916.2219 0 .4466-.0179.6737-.0559a4.5933 4.5933 0 0 0 1.6844-.6217c.3111.0326.6237.0489.9341.0489 1.3124 0 2.5625-.392 3.5921-1.1286a5.6747 5.6747 0 0 0 1.0326-.9398c.3144.0262.6432.0359.9828.0236 1.6778-.0607 3.1891-.5285 4.2498-1.3175.6225-.4633.9981-.9986 1.0245-1.4612a.5765.5765 0 0 0-.0303-.2256z" />
    </svg>
  )
}

// MySQL logo icon (for future use)
...
// BigQuery logo icon (for future use)
export function BigQueryIcon(props: IconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
      ...
      {...props}
    >
      <path d="M6.738 16.303l-3.39 3.39A11.947 11.947 0 0 0 12 24c2.636 0 5.082-.851 7.07-2.293l-3.389-3.39a7.18 7.18 0 0 1-8.943-2.014zm13.03-4.225a7.178 7.178 0 0 1-2.035 8.943l3.39 3.39A11.947 11.947 0 0 0 24 12c0-2.636-.851-5.082-2.293-7.07l-3.39 3.389a7.178 7.178 0 0 1 1.45 3.76zM12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 17.18A5.18 5.18 0 1 1 12 6.82a5.18 5.18 0 0 1 0 10.36zm0-8.433a3.253 3.253 0 1 0 0 6.506 3.253 3.253 0 0 0 0-6.506z" />
    </svg>
  )
}

// Data connection type to icon mapping utility
export type DataConnectionType = "snowflake" | "postgres" | "mysql" | "bigquery"

export const DATA_CONNECTION_ICONS: Record<DataConnectionType, React.FC<IconProps>> = {
...
export const DATA_CONNECTION_COLORS: Record<DataConnectionType, string> = {
  snowflake: "text-[#29B5E8]",
  postgres: "text-[#4169E1]",
  mysql: "text-[#4479A1]",
  bigquery: "text-[#669DF6]",
}

export function getDataConnectionIcon(type: DataConnectionType): React.FC<IconProps> {
  return DATA_CONNECTION_ICONS[type] || SnowflakeIcon
}

export function getDataConnectionColor(type: DataConnectionType): string {
  return DATA_CONNECTION_COLORS[type] || "text-muted-foreground"
}
