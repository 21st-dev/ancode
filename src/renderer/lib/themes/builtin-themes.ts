...
/**
 * Crunch Dark - Default dark theme matching the app's original design
...
/**
 * Crunch Light - Default light theme matching the app's original design
 * Uses the brand blue (#0034FF) as primary/accent color
 */
 ...
 */
export const DEFAULT_LIGHT_THEME_ID = "crunch-light"
export const DEFAULT_DARK_THEME_ID = "crunch-dark"
