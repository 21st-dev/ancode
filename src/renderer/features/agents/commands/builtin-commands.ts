...
2. Create the file .crunch/worktree.json with setup commands
...
Example output for .crunch/worktree.json:
{
  "setup-worktree": [
    "bun install",
...
Now analyze this project and create .crunch/worktree.json with the appropriate setup commands.`,
}
